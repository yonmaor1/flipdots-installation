 ...
 * 
 * @param {int} width_in width of canvas
 * @param {int} height_in: height of the canvas
 * @param {int} width_out: width of the output image (ncols in the flip dot display)
 * 
 * @return {int[]} brightnesses
 */
 ...
 * 
 * @param {int[]} rasterized_brightnesses brightnesses
 * @param {int} width_out width of the output image (ncols in the flip dot display)
*/
