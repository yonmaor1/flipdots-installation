 ...
 */
let config_cast = false;
let config_fps = 30;
let config_canvasW;
let config_canvasH;
let config_video_sync = true;
let config_show_simulator = true;
let config_cast_only_changed = false;
let config_simulate_changes = false;
...
// Create adapters
let adaptersNet = new Client[netAdapters.length];
let adaptersSerial = new Serial[serialAdapters.length];

// Assets
let FlipDotFont;
let FlipDotFont_pixel;
...
function config_setup() {
    ...
    // Fonts
    FlipDotFont = loadFont("fonts/zxSpectrumStrictCondensed.ttf"); // Good all round small font
    ...
    FlipDotFont_pixel = loadFont("fonts/m3x6.ttf"); // Good general pixel font
